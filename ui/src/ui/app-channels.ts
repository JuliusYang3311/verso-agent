...
function resolveNostrAccountId(host: VersoApp): string {
...
export function handleNostrProfileCancel(host: VersoApp) {
...
export function handleNostrProfileToggleAdvanced(host: VersoApp) {
  const state = host.nostrProfileFormState;
  if (!state) return;
  host.nostrProfileFormState = {
    ...state,
...
export async function handleNostrProfileSave(host: VersoApp) {
  const state = host.nostrProfileFormState;
...
export async function handleNostrProfileImport(host: VersoApp) {
  const state = host.nostrProfileFormState;
