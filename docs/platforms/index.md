...
- Service status: `verso gateway status`

## Gateway service install (CLI)

Use one of these (all supported):

- Wizard (recommended): `verso onboard --install-daemon`
- Direct: `verso gateway install`
- Configure flow: `verso configure` → select **Gateway service**
