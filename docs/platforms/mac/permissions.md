...
- Same path: run the app from a fixed location (for Verso, `dist/Verso.app`).
...
Workaround: move files into the Verso workspace (`~/.openclaw/workspace`) if you want to avoid per-folder grants.
