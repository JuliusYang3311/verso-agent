---
title: CI Pipeline
description: How the Verso CI pipeline works and why jobs are ordered the way they are.
---

# CI Pipeline

Verso uses a tiered CI pipeline that fails fast on cheap checks before
