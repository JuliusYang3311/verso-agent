...
Under the hood, requests are executed as a normal Gateway agent run (same codepath as `verso agent`), so routing/permissions/config match your Gateway.
...
- `model: "verso:<agentId>"` (example: `"verso:main"`, `"verso:beta"`)
