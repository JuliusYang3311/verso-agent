...
Verso ships three update channels:
...
When you **explicitly** switch channels with `--channel`, Verso also aligns
the install method:
...
When you switch channels with `verso update`, Verso also syncs plugin sources:
