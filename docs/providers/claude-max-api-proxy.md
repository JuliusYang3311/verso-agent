...
You can point Verso at the proxy as a custom OpenAI-compatible endpoint:
...
- This is a **community tool**, not officially supported by Anthropic or Verso
...
- [Anthropic provider](/providers/anthropic) - Native Verso integration with Claude setup-token or API keys
