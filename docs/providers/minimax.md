---
summary: "Use MiniMax M2.1 in Verso"
read_when:
  - You want MiniMax models in Verso
...
Configure manually via `verso.json`:
...
- Use `verso models list` and `verso models set minimax/MiniMax-M2.1` to switch.
...
- Running `verso configure` and selecting **MiniMax M2.1**, or
