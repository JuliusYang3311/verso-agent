---
summary: "Use Xiaomi MiMo (mimo-v2-flash) with Verso"
read_when:
  - You want Xiaomi MiMo models in Verso
...
the [Xiaomi MiMo console](https://platform.xiaomimimo.com/#/console/api-keys). Verso uses
...
```bash
verso onboard --auth-choice xiaomi-api-key
# or non-interactive
verso onboard --auth-choice xiaomi-api-key --xiaomi-api-key "$XIAOMI_API_KEY"
```
