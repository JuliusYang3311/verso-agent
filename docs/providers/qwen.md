---
summary: "Use Qwen OAuth (free tier) in Verso"
read_when:
...
```bash
verso models set qwen-portal/coder-model
```

## Reuse Qwen Code CLI login

If you already logged in with the Qwen Code CLI, Verso will sync credentials
