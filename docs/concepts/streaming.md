...
Verso has two separate “streaming” layers:
...
When block streaming is enabled, Verso can **merge consecutive block chunks**
...
When draft streaming is active, Verso disables block streaming for that reply to avoid double-streaming.
