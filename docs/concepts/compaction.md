...
Before compaction, Verso can run a **silent memory flush** turn to store
...
Context window is model-specific. Verso uses the model definition from the configured provider catalog to determine limits.
