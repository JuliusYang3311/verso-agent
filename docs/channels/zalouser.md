...
read_when:
  - Setting up Zalo Personal for Verso
...
- On startup, Verso resolves group/user names in allowlists to IDs and logs the mapping; unresolved entries are kept as typed.
