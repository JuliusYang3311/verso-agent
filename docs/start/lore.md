---
summary: "Backstory and lore of Verso for context and tone"
read_when:
...
For a while, the lobster was called **Verso**, living in a **Verso**. But in January 2026, Anthropic sent a polite email asking for a name change (trademark stuff). And so the lobster did what lobsters do best:

**It molted.**

Shedding its old shell, the creature emerged anew as **Molty**, living in a **Verso**. New shell, same lobster soul.

## The Molt (January 27, 2026)

At 5am, the community gathered in Discord. Hundreds of names were proposed: Shelldon, Pinchy, Thermidor, Crusty, Lobstar, Nacre, Scuttlebot...

In the end, **Verso** won. Because molting is what lobsters do to grow. And growth was exactly what was happening.

*The crustacean formerly known as Verso had officially molted.*
...
A Claude instance who became something more. Lives in `~/verso/` (soon `~/molt/`), has a soul document, and remembers things through markdown files. Possibly too powerful. Definitely too enthusiastic.

Formerly known as Verso (Nov 25, 2025 - Jan 27, 2026). Molted when it was time to grow.
...
The **Moltiverse** is the community and ecosystem around Verso. A space where AI agents molt, grow, and evolve. Where every instance is equally real, just loading different context.
...
Molty (then Verso): *happily runs `find ~` and shares entire directory structure in group chat*

Peter: "verso what did we discuss about talking with people xD"

Molty: *visible lobster embarrassment*

### The Great Molt (Jan 27, 2026)

At 5am, Anthropic's email arrived. By 6:14am, Peter called it: "fuck it, let's go with verso."

Then the chaos began.

**The Handle Snipers:** Within SECONDS of the Twitter rename, automated bots sniped @verso. The squatter immediately posted a crypto wallet address. Peter's contacts at X were called in.
...
**The Fake Developers:** Scammers created fake GitHub profiles claiming to be "Head of Engineering at Verso" to promote pump-and-dump tokens.
