...
Verso treats **wake words as a single global list** owned by the **Gateway**.
...
- `~/.verso/settings/voicewake.json`

Shape:

```json
{ "triggers": ["verso", "claude", "computer"], "updatedAtMs": 1730000000000 }
```
