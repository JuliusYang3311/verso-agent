...
You can also set `VERSO_VERBOSE=1` instead of the flag.
...
- Check the allowlist: `verso config get agents.defaults.models`
...
If you can, include the relevant log tail from `verso logs --follow`.
