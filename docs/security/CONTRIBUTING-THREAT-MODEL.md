# Contributing to the Verso Threat Model

Thanks for helping make Verso more secure. This threat model is a living document and we welcome contributions from anyone - you don't need to be a security expert.
...
- Which parts of Verso are affected (CLI, gateway, channels, ClawHub, MCP servers, etc.)
...
- [Verso Threat Model](./THREAT-MODEL-ATLAS.md)
...
Contributors to the threat model are recognized in the threat model acknowledgments, release notes, and the Verso security hall of fame for significant contributions.
