...
export const CANVAS_HOST_PATH = "/__verso__/canvas";
export const CANVAS_WS_PATH = "/__verso/ws";
...
(() => {
  ...
  globalThis.Verso = globalThis.Verso ?? {};
  globalThis.Verso.postMessage = postToNode;
  globalThis.Verso.sendUserAction = sendUserAction;
  globalThis.versoPostMessage = postToNode;
  globalThis.versoSendUserAction = sendUserAction;
  globalThis.versoPostMessage = postToNode;
  globalThis.versoSendUserAction = sendUserAction;
