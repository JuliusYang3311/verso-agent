...
export function listBindings(cfg: VersoConfig): AgentBinding[] {
  return Array.isArray(cfg.bindings) ? cfg.bindings : [];
}

export function listBoundAccountIds(cfg: VersoConfig, channelId: string): string[] {
...
export function buildChannelAccountBindings(cfg: VersoConfig) {
