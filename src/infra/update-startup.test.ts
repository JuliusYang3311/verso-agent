...
describe("update-startup", () => {
  ...
  beforeEach(async () => {
    ...
    tempDir = await fs.mkdtemp(path.join(os.tmpdir(), "verso-update-check-"));
  ...
  it("logs update hint for npm installs when newer tag exists", async () => {
    const { resolveVersoPackageRoot } = await import("./verso-root.js");
    ...
    vi.mocked(resolveVersoPackageRoot).mockResolvedValue("/opt/verso");
