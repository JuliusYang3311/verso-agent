...
export class DirectoryCache<T> {
  ...
  private lastConfigRef: VersoConfig | null = null;

  constructor(private readonly ttlMs: number) {}

  get(key: string, cfg: VersoConfig): T | undefined {
  ...
  set(key: string, value: T, cfg: VersoConfig): void {
    this.resetIfConfigChanged(cfg);
  ...
  private resetIfConfigChanged(cfg: VersoConfig): void {
