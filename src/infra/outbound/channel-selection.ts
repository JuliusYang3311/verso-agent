...
async function isPluginConfigured(plugin: ChannelPlugin, cfg: VersoConfig): Promise<boolean> {
...
export async function listConfiguredMessageChannels(cfg: VersoConfig): Promise<MessageChannelId[]> {
