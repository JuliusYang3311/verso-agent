...
import type { CryptoConfig } from "./types.crypto.js";
import type {
  CanvasHostConfig,
  DiscoveryConfig,
  GatewayConfig,
...
import type { GoogleConfig } from "./types.google.js";
...
import type { TwitterConfig } from "./types.twitter.js";
import type { VideoGenerationConfig } from "./types.video-generation.js";

export type VersoConfig = {
  meta?: {
    /** Last verso version that wrote this config. */
  ...
  ui?: {
    /** Accent color for Verso UI chrome (hex). */
    seamColor?: string;
    assistant?: {
