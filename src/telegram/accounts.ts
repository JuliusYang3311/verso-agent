...
export function listTelegramAccountIds(cfg: VersoConfig): string[] {
...
export function resolveDefaultTelegramAccountId(cfg: VersoConfig): string {
...
function mergeTelegramAccountConfig(cfg: VersoConfig, accountId: string): TelegramAccountConfig {
...
export function listEnabledTelegramAccounts(cfg: VersoConfig): ResolvedTelegramAccount[] {
