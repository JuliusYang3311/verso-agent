...
${formatHelpExamples([
  ['verso message send --target +15555550123 --message "Hi"', "Send a text message."],
  [
    'verso message send --target +15555550123 --message "Hi" --media photo.jpg',
  ...
  [
    'verso message react --channel discord --target 123 --message-id 456 --emoji "✅"',
    "React to a message.",
  ],
])}

${theme.muted("Docs:")} ${formatDocsLink("/cli/message", "docs.verso.ai/cli/message")}`,
    )
    .action(() => {
