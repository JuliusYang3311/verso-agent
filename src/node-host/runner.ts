...
const execHostEnforced = process.env.VERSO_NODE_EXEC_HOST?.trim().toLowerCase() === "app";
const execHostFallbackAllowed = process.env.VERSO_NODE_EXEC_FALLBACK?.trim().toLowerCase() !== "0";
