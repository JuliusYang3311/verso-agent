...
export type { VersoConfig } from "../config/config.js";
/** @deprecated Use VersoConfig instead */
export type { VersoConfig as ClawdbotConfig } from "../config/config.js";
