...
export function applyZaiConfig(cfg: VersoConfig): VersoConfig {
...
export function applyOpenrouterProviderConfig(cfg: VersoConfig): VersoConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyVercelAiGatewayProviderConfig(cfg: VersoConfig): VersoConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyVercelAiGatewayConfig(cfg: VersoConfig): VersoConfig {
...
export function applyOpenrouterConfig(cfg: VersoConfig): VersoConfig {
...
export function applyMoonshotProviderConfig(cfg: VersoConfig): VersoConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyMoonshotProviderConfigCn(cfg: VersoConfig): VersoConfig {
  const models = { ...cfg.agents?.defaults?.models };
  models[MOONSHOT_DEFAULT_MODEL_REF] = {
    ...models[MOONSHOT_DEFAULT_MODEL_REF],
    alias: models[MOONSHOT_DEFAULT_MODEL_REF]?.alias ?? "Kimi",
...
export function applyMoonshotConfig(cfg: VersoConfig): VersoConfig {
...
export function applyMoonshotConfigCn(cfg: VersoConfig): VersoConfig {
...
export function applyCloudflareAiGatewayProviderConfig(
  ...
  const baseUrl =
    accountId && gatewayId ? resolveCloudflareAiGatewayBaseUrl({ accountId, gatewayId }) : "";
  if (baseUrl) {
    const existingProvider = providers["cloudflare-ai-gateway"] as
...
export function applyKimiCodeProviderConfig(cfg: VersoConfig): VersoConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyKimiCodeConfig(cfg: VersoConfig): VersoConfig {
...
export function applySyntheticProviderConfig(cfg: VersoConfig): VersoConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applySyntheticConfig(cfg: VersoConfig): VersoConfig {
...
export function applyXiaomiProviderConfig(cfg: VersoConfig): VersoConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyXiaomiConfig(cfg: VersoConfig): VersoConfig {
 ...
 */
export function applyVeniceProviderConfig(cfg: VersoConfig): VersoConfig {
  const models = { ...cfg.agents?.defaults?.models };
 ...
 */
export function applyVeniceConfig(cfg: VersoConfig): VersoConfig {
...
export function applyXaiProviderConfig(cfg: VersoConfig): VersoConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyXaiConfig(cfg: VersoConfig): VersoConfig {
...
export function applyQianfanProviderConfig(cfg: VersoConfig): VersoConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyQianfanConfig(cfg: VersoConfig): VersoConfig {
