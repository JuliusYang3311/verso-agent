...
export async function setupInternalHooks(
  ...
  await prompter.note(
    [
      ...
      "",
      "Learn more: https://docs.verso.ai/hooks",
    ].join("\n"),
    "Hooks",
  );
  ...
  await prompter.note(
    [
      ...
      `  ${formatCliCommand("verso hooks list")}`,
      `  ${formatCliCommand("verso hooks enable <name>")}`,
      `  ${formatCliCommand("verso hooks disable <name>")}`,
    ].join("\n"),
    "Hooks Configured",
  );
