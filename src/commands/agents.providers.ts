...
function resolveDefaultAccountId(cfg: VersoConfig, provider: ChannelId): string {
...
function shouldShowProviderEntry(entry: ProviderAccountStatus, cfg: VersoConfig): boolean {
...
export function summarizeBindings(cfg: VersoConfig, bindings: AgentBinding[]): string[] {
