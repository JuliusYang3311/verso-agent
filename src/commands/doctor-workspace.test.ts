...
describe("detectLegacyWorkspaceDirs", () => {
  it("ignores ~/verso when it doesn't look like a workspace (e.g. install dir)", () => {
    const home = "/home/user";
    const workspaceDir = "/home/user/verso";
    const candidate = path.join(home, "verso");
  ...
  it("flags ~/verso when it contains workspace markers", () => {
    const home = "/home/user";
    const workspaceDir = "/home/user/verso";
    const candidate = path.join(home, "verso");
