...
describe("commands registry", () => {
  ...
  it("normalizes telegram-style command mentions for the current bot", () => {
    expect(normalizeCommandBody("/help@verso", { botUsername: "verso" })).toBe("/help");
    expect(
      normalizeCommandBody("/help@verso args", {
        botUsername: "verso",
      }),
    ).toBe("/help args");
    expect(
  ...
  it("keeps telegram-style command mentions for other bots", () => {
    expect(normalizeCommandBody("/help@otherbot", { botUsername: "verso" })).toBe("/help@otherbot");
  });
