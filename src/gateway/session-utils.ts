...
function listConfiguredAgentIds(cfg: VersoConfig): string[] {
...
export function listAgentsForGateway(cfg: VersoConfig): {
  defaultId: string;
  mainKey: string;
  scope: SessionScope;
...
function resolveDefaultStoreAgentId(cfg: VersoConfig): string {
  return normalizeAgentId(resolveDefaultAgentId(cfg));
}

export function resolveSessionStoreKey(params: { cfg: VersoConfig; sessionKey: string }): string {
...
function resolveSessionStoreAgentId(cfg: VersoConfig, canonicalKey: string): string {
...
export function resolveGatewaySessionStoreTarget(params: { cfg: VersoConfig; key: string }): {
  agentId: string;
  storePath: string;
  canonicalKey: string;
  storeKeys: string[];
...
export function loadCombinedSessionStoreForGateway(cfg: VersoConfig): {
  storePath: string;
...
export async function pruneAndLoadCombinedSessionStoreForGateway(cfg: VersoConfig): Promise<{
  storePath: string;
  store: Record<string, SessionEntry>;
}> {
...
export function getSessionDefaults(cfg: VersoConfig): GatewaySessionsDefaults {
