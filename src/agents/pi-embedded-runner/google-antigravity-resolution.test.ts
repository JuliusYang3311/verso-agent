...
describe("resolveModel for google-antigravity", () => {
  ...
  it("should resolve google-antigravity/gemini-3-flash-preview correctly", () => {
    ...
    if (result.model) {
      expect(result.model.id).toBe("gemini-3-flash-preview");
  ...
  it("should resolve shorthand gemini-3-flash-preview correctly", () => {
    const result = resolveModel(
      "google-antigravity",
