 ...
 */
const PENDING_DISPATCH_MESSAGES = new Map<string, string[]>();
const PENDING_DISPATCH_TIMESTAMPS = new Map<string, number>();
 ...
 */
export function markDispatchPending(sessionId: string): void {
 ...
 */
export function clearDispatchPending(sessionId: string): void {
  PENDING_DISPATCH_MESSAGES.delete(sessionId);
  PENDING_DISPATCH_TIMESTAMPS.delete(sessionId);
}
 ...
 */
export function isDispatchPending(sessionId: string): boolean {
 ...
 */
export function queuePendingMessage(sessionId: string, text: string): boolean {
