...
function resolveAvatarSource(cfg: VersoConfig, agentId: string): string | null {
...
export function resolveAgentAvatar(cfg: VersoConfig, agentId: string): AgentAvatarResolution {
