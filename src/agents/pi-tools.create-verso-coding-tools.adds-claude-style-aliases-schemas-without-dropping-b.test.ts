...
describe("createVersoCodingTools", () => {
  ...
  it("gates apply_patch behind tools.exec.applyPatch for OpenAI models", () => {
    ...
    const openAiTools = createVersoCodingTools({
      config,
    ...
    const anthropicTools = createVersoCodingTools({
      config,
  ...
  it("respects apply_patch allowModels", () => {
    ...
    const allowed = createVersoCodingTools({
      config,
      modelProvider: "openai",
      modelId: "gpt-5.2",
    });
    ...
    const denied = createVersoCodingTools({
      config,
      modelProvider: "openai",
      modelId: "gpt-5-mini",
    });
