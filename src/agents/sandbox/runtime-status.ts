...
function resolveMainSessionKeyForSandbox(params: { cfg?: VersoConfig; agentId: string }): string {
...
export function resolveSandboxRuntimeStatus(params: { cfg?: VersoConfig; sessionKey?: string }): {
  agentId: string;
  sessionKey: string;
