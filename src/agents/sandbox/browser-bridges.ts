import { type BrowserBridge, stopBrowserBridgeServer } from "../../browser/bridge-server.js";
 ...
 */
export async function releaseSessionBrowserBridge(sessionKey: string): Promise<void> {
