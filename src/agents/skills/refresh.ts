...
function resolveWatchPaths(workspaceDir: string, config?: VersoConfig): string[] {
  const paths: string[] = [];
...
export function ensureSkillsWatcher(params: { workspaceDir: string; config?: VersoConfig }) {
