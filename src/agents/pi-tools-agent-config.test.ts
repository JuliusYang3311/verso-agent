...
describe("Agent-specific tool filtering", () => {
  ...
  it("should allow different tool policies for different agents", () => {
    ...
    const mainTools = createVersoCodingTools({
      config: cfg,
      sessionKey: "agent:main:main",
    ...
    const familyTools = createVersoCodingTools({
      config: cfg,
  ...
  it("should apply group tool policy overrides (group-specific beats wildcard)", () => {
    ...
    const trustedTools = createVersoCodingTools({
      config: cfg,
    ...
    const defaultTools = createVersoCodingTools({
      config: cfg,
  ...
  it("should apply per-sender tool policies for group tools", () => {
    ...
    const aliceTools = createVersoCodingTools({
      config: cfg,
    ...
    const bobTools = createVersoCodingTools({
      config: cfg,
      sessionKey: "agent:main:whatsapp:group:family",
      senderId: "bob",
  ...
  it("should not let default sender policy override group tools", () => {
    ...
    const adminTools = createVersoCodingTools({
      config: cfg,
