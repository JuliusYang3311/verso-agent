...
export const sheetsCreateSpreadsheet: AnyAgentTool = {
...
export const sheetsAppendValues: AnyAgentTool = {
...
export const calendarListEvents: AnyAgentTool = {
...
export const calendarCreateEvent: AnyAgentTool = {
...
export const driveListFiles: AnyAgentTool = {
...
export const slidesCreatePresentation: AnyAgentTool = {
...
export const driveUploadFile: AnyAgentTool = {
