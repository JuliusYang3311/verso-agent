...
function setGroupPolicyAllowlist(params: {
  ...
  const section = params.cfg.channels[params.channel as keyof VersoConfig["channels"]] as
...
function applyConfigFixes(params: { cfg: VersoConfig; env: NodeJS.ProcessEnv }): {
  cfg: VersoConfig;
  changes: string[];
  policyFlips: Set<string>;
} {
