...
The **Capability Evolver** is a meta-skill that allows Verso agents to inspect their own runtime history, identify failures or inefficiencies, and autonomously write new code or update their own memory to improve performance.
...
This skill is designed to be **environment-agnostic**. It uses standard Verso tools by default.
