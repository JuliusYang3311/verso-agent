          ...
          try {
            ...
            globalThis.addEventListener('a2uiaction', (evt) => {
              try {
                ...
                const handler = globalThis.webkit?.messageHandlers?.versoCanvasA2UIAction;
                ...
                const hasBundledA2UIHost = !!globalThis.versoA2UI || !!document.querySelector('moltbot-a2ui-host');
