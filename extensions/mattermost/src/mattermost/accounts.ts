...
export function listMattermostAccountIds(cfg: VersoConfig): string[] {
...
export function resolveDefaultMattermostAccountId(cfg: VersoConfig): string {
...
export function listEnabledMattermostAccounts(cfg: VersoConfig): ResolvedMattermostAccount[] {
