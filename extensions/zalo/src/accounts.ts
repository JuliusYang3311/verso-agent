...
export function listZaloAccountIds(cfg: VersoConfig): string[] {
...
export function resolveDefaultZaloAccountId(cfg: VersoConfig): string {
...
function resolveAccountConfig(cfg: VersoConfig, accountId: string): ZaloAccountConfig | undefined {
  const accounts = (cfg.channels?.zalo as ZaloConfig | undefined)?.accounts;
  if (!accounts || typeof accounts !== "object") {
    return undefined;
  }
...
function mergeZaloAccountConfig(cfg: VersoConfig, accountId: string): ZaloAccountConfig {
...
export function listEnabledZaloAccounts(cfg: VersoConfig): ResolvedZaloAccount[] {
