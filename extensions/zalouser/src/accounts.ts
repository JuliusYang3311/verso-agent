...
export function listZalouserAccountIds(cfg: VersoConfig): string[] {
...
export function resolveDefaultZalouserAccountId(cfg: VersoConfig): string {
...
function mergeZalouserAccountConfig(cfg: VersoConfig, accountId: string): ZalouserAccountConfig {
