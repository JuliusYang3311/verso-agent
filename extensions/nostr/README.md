...
Nostr DM channel plugin for Verso using NIP-04 encrypted direct messages.

## Overview

This extension adds Nostr as a messaging channel to Verso. It enables your bot to:
...
# Configure verso to use local relay
