...
import { removeAckReactionAfterReply, shouldAckReaction } from "verso/plugin-sdk";
...
function createMockRuntime(): PluginRuntime {
  return {
    ...
    state: {
      resolveStateDir: vi.fn(() => "/tmp/verso") as unknown as PluginRuntime["state"]["resolveStateDir"],
    },
  };
}
