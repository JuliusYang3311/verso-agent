...
export function listBlueBubblesAccountIds(cfg: VersoConfig): string[] {
...
export function resolveDefaultBlueBubblesAccountId(cfg: VersoConfig): string {
...
export function listEnabledBlueBubblesAccounts(cfg: VersoConfig): ResolvedBlueBubblesAccount[] {
