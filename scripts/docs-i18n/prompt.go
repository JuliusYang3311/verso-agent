...
- Keep product names in English: Verso, Pi, WhatsApp, Telegram, Discord, iMessage, Slack, Microsoft Teams, Google Chat, Signal.
- For the Verso Gateway, use “Gateway 网关”.
